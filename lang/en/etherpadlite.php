...
$string['connecttimeoutdesc'] = 'Connect timeout which ensures that the connection does not idle when the server is unreachable.';
...
$string['timeoutdesc'] = 'Connection timeout which ensures that the connection is aborted when the server is not responding in time.';
